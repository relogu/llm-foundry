...
```
bash parametrisation_examples/mup/coord_check_shakespeare_char/sp/run.sh
```

And muP:

```
bash parametrisation_examples/mup/coord_check_shakespeare_char/mup/run.sh
```

These scripts populate the `out/` subdirectories with your coord check data, which you can then plot with `parametrisation_examples/mup/coord_check_shakespeare_char/plot.ipynb`
...
```
bash parametrisation_examples/mup/mutransfer_lr_shakespeare_char/mup/run.sh
```

and SP:

```
bash parametrisation_examples/mup/mutransfer_lr_shakespeare_char/sp/run.sh
```
...
```
bash parametrisation_examples/mup/mutransfer_lr_owt/mup/run.sh
```

and SP:

```
bash parametrisation_examples/mup/mutransfer_lr_owt/sp/run.sh
```

These scripts populate

These scripts populate the `out/` subdirectories with your train loss data, which you can then plot with `parametrisation_examples/mup/mutransfer_lr/plot.ipynb`

## CompleteP Depth Coordinate Checks

To reproduce the figures from the CompleteP paper run:
...
The results can be plotted using `parametrisation_examples/completep/coord_check_shakespeare_char/plot.ipynb`.
